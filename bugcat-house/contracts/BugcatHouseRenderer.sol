...
contract BugcatHouseRenderer is IRender {
    ...
    function render(
        ...
        string memory html = string.concat(
            ...
            "<body>",
            "<div class=\"container\">",
            "<div id=\"info\" style=\"color: #ffffff; font-size: min(1.5vw, 16px); margin-bottom: 0.5vw; text-align: center; line-height: 1.3;\">",
            "<div style=\"font-size: min(1.8vw, 18px); font-weight: bold; margin-bottom: 1.2vw; opacity: 1;\">", title, "</div>",
            "<div id=\"caretaker-info\" style=\"margin-bottom: 0.6vw; opacity: 0.9; font-size: min(1.5vw, 16px);\">", line1, "</div>",
            "<div id=\"visit-info\" style=\"opacity: 0.8; font-size: min(1.5vw, 16px);\">", line2, "</div>",
            "</div>",
